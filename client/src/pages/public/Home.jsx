...
const quickLinks = [
  ...
  {
    title: "About Us",
    text: "Rehoboth Prime Years provides a Biblically-based worldview of learning that prepares the hearts, minds, and spirits of learners.",
    to: "/about"
  },
  {
...
const schoolEvents = ["Yearly inter-house sports week", "Cultural Christmas program", "Field trips", "National, Regional, and International Student Conventions", "Rehoboth Prime Years yearly thanksgiving Sunday service", "Graduation and special resurrection programs"];
...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="container-pad py-16">
        <SectionTitle eyebrow="Statement of Faith" title="What Rehoboth Prime Years believes" />
